...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042792693525964458)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042792707871964458)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(72042792919466964458)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(72042792707871964458)
,p_template=>wwv_flow_imp.id(72041466668134963062)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(72042800073140964468)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(72043400471052964468)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042793074559964458)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042793181447964458)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72043829193024964684)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72043830970590964685)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042793297460964458)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(72042792693525964458)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72043832474728964685)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72043833251459964686)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(72042792693525964458)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72043835489055964687)
,p_name=>'P10044_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72042793181447964458)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72043836264007964687)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72043836928738964687)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(72043833363873964686)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(72043833251459964686)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(72043834500448964686)
,p_event_id=>wwv_flow_imp.id(72043833363873964686)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72043837600640964688)
...
,p_process_when_button_id=>wwv_flow_imp.id(72042793297460964458)
,p_process_success_message=>'User(s) added.'
,p_internal_uid=>72043837600640964688
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72043838720743964688)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>72043838720743964688
);

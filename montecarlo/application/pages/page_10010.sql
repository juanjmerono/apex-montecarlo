...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042606568342963888)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042606717687963888)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(72042607366439963889)
,p_name=>'Configuration Options'
...
,p_internal_uid=>72042607366439963889
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042610740891963893)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042611571544963894)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042612245839963894)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042612924815963895)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042613653400963895)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042614343000963895)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042615046038963895)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(72042620943197963898)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'720426211'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'APPLICATION_OPTION:STATUS:DESCRIPTION:UPDATED:UPDATED_BY'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042624317359963899)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(72042606568342963888)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042622991059963899)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(72042606717687963888)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(72042625975994963900)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042625175460963900)
...
,p_internal_uid=>72042625175460963900
);

...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042758218372964413)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(72042758812526964414)
,p_name=>'Automations Log'
...
,p_internal_uid=>72042758812526964414
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042759508400964419)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042759962977964420)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042760305016964420)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042760720219964420)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042761160018964421)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042761553715964421)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042761987911964421)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042762314916964421)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(72042762733990964422)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(72042766104281964425)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'720427662'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042767073026964425)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(72042758218372964413)

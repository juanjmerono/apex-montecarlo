...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042773953181964434)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042774041616964434)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042775222585964435)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(72042774041616964434)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042775583646964436)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(72042776958864964437)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042777200401964437)
,p_name=>'P10040_ALLOW_OTHER_USERS'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(72042773953181964434)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(72042775628525964436)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(72042775583646964436)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(72042776383123964437)
,p_event_id=>wwv_flow_imp.id(72042775628525964436)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042777672869964438)
...
,p_internal_uid=>72042777672869964438
);

...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042626597303963900)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042626641625963900)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042631822736963903)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(72042626597303963900)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042629573947963902)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(72042632492467963903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042632996371963903)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72042626641625963900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042636248276963908)
...
,p_lov=>'.'||wwv_flow_imp.id(72042636375673963908)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(72042629637610963902)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(72042629573947963902)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(72042630772753963902)
,p_event_id=>wwv_flow_imp.id(72042629637610963902)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042637704635963909)
...
,p_internal_uid=>72042637704635963909
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042638331792963909)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Application Appearance Settings Saved.'
,p_internal_uid=>72042638331792963909
);

...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042784739588964448)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72042784897065964448)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042787639309964451)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(72042784897065964448)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042788039101964451)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042785837532964450)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(72042787288460964450)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042788390496964451)
,p_name=>'P10042_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72042784739588964448)
,p_item_source_plug_id=>wwv_flow_imp.id(72042784739588964448)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042788778727964451)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042789148650964452)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72042789504765964452)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(72042790888046964457)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(72042785932845964450)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(72042785837532964450)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(72042786657733964450)
,p_event_id=>wwv_flow_imp.id(72042785932845964450)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042791101229964457)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(72042784739588964448)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Manage User Access'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>72042791101229964457
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042791562921964457)
...
,p_attribute_08=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>72042791562921964457
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(72042791990287964458)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>72042791990287964458
);

...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(72043846937909964693)
,p_name=>'Activity Reports'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(72042304415161963296)
,p_version_scn=>15587803345993
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043847603841964693)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043848212759964694)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043848708470964694)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043849343513964694)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043849998684964695)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043850461640964695)

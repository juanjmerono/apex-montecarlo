...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(72043850962679964695)
,p_name=>'Access Control'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(72042304375244963296)
,p_version_scn=>15587803346087
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043851443164964695)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(72043852090121964696)

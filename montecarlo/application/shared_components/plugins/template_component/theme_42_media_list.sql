...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(72042246925331963237)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(73842265379806846889)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(73842264824794846888)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042247695843963244)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042247984101963244)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042248252572963245)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042248556032963245)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042248841647963245)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72042248252572963245)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(73842265379806846889)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042249174956963246)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042248841647963245)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042249505288963246)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042248841647963245)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042249975722963247)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042248841647963245)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042250358005963247)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72042248841647963245)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042250660820963247)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042250934535963247)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042251264155963248)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042251505289963248)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042251817944963248)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042251505289963248)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042252235231963249)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042251505289963248)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042252643833963249)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042251505289963248)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042253009319963249)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042251505289963248)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042253494807963250)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(72042248556032963245)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(73842264824794846888)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042253720212963250)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042254004363963251)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042254337283963251)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042254657188963251)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042254913884963252)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042255239597963252)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042254913884963252)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042255669221963253)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042254913884963252)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042256059435963253)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042256338043963253)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042256059435963253)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042256754566963253)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042256059435963253)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042257144257963254)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042256059435963253)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042257526060963254)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042257876755963254)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042257526060963254)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042258251764963255)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042257526060963254)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042258622398963255)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042257526060963254)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042259090300963255)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042257526060963254)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042259493134963256)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042257526060963254)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042259809598963256)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042260175653963256)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042259809598963256)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042260532883963257)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(73842468431963993517)
,p_plugin_id=>wwv_flow_imp.id(72042246925331963237)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(72041590436153963150)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041591168443963152)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041591899954963153)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041591168443963152)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041592514332963153)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041591168443963152)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041592970160963154)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041591168443963152)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041593333250963154)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72041591168443963152)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041593652445963154)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041593970292963155)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041594283255963155)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041594555269963155)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041594813339963156)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041594555269963155)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041595243836963156)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041594555269963155)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041595698971963156)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041594555269963155)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041596094390963157)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041594555269963155)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041596426039963157)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041596796403963157)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041597178888963158)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041597532004963158)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041597928891963158)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041598310506963159)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041598745269963159)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72041599141418963159)
,p_plugin_attribute_id=>wwv_flow_imp.id(72041596426039963157)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72041599558130963160)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(73841641753333076904)
,p_plugin_id=>wwv_flow_imp.id(72041590436153963150)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

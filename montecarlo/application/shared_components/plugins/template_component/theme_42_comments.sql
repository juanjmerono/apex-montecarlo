...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(72042209480536963176)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(73842094886197994894)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042209923423963180)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042210224983963180)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042210538004963181)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042210862768963181)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042211186409963182)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72042215704454963187)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(73842094886197994894)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042211477003963182)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042211186409963182)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042211805093963183)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042211186409963182)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042212238039963183)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042211186409963182)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042212649737963183)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72042211186409963182)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042212941173963184)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042213247691963184)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042213548306963185)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042213855989963185)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042214158058963186)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042213855989963185)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042214569014963186)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042213855989963185)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042214918080963187)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042213855989963185)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042215368854963187)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042213855989963185)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042215704454963187)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042216050423963188)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042216396341963188)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042216661591963189)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042216396341963188)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042217072361963189)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042216396341963188)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042217437546963189)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(73842227553631096397)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(73842226962126088940)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(73842282585796070819)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(73842434803508941590)
,p_plugin_id=>wwv_flow_imp.id(72042209480536963176)

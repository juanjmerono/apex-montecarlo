...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(72042200629918963163)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042200955117963165)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042201220269963165)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042201542153963166)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042201835887963166)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042202151812963166)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042202483688963167)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042202715054963167)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042202483688963167)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042203134149963167)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042202483688963167)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042203595254963168)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042203851666963168)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042203595254963168)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042204242307963168)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042203595254963168)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042204620356963169)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042203595254963168)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72042205080936963169)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042205343853963170)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042205080936963169)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042205782267963170)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042205080936963169)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72042206168597963170)
,p_plugin_attribute_id=>wwv_flow_imp.id(72042205080936963169)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(73553682866105065353)
,p_plugin_id=>wwv_flow_imp.id(72042200629918963163)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

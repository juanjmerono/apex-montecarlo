...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041454893233963055)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041455154033963056)
,p_plug_template_id=>wwv_flow_imp.id(72041454893233963055)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041455466755963056)
,p_plug_template_id=>wwv_flow_imp.id(72041454893233963055)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041455731176963056)
,p_plug_template_id=>wwv_flow_imp.id(72041454893233963055)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041476467407963067)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041476734584963067)
,p_plug_template_id=>wwv_flow_imp.id(72041476467407963067)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041477025895963067)
,p_plug_template_id=>wwv_flow_imp.id(72041476467407963067)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041477353253963067)
,p_plug_template_id=>wwv_flow_imp.id(72041476467407963067)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041477643534963067)
,p_plug_template_id=>wwv_flow_imp.id(72041476467407963067)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041477942597963067)
,p_plug_template_id=>wwv_flow_imp.id(72041476467407963067)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041478296405963067)
,p_plug_template_id=>wwv_flow_imp.id(72041476467407963067)
,p_name=>'Sub Regions'

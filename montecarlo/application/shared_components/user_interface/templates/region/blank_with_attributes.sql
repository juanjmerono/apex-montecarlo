...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041447761982963051)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041448000819963051)
,p_plug_template_id=>wwv_flow_imp.id(72041447761982963051)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041448309641963052)
,p_plug_template_id=>wwv_flow_imp.id(72041447761982963051)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041448660650963052)
,p_plug_template_id=>wwv_flow_imp.id(72041447761982963051)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041448930680963052)
,p_plug_template_id=>wwv_flow_imp.id(72041447761982963051)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041511666958963083)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041511934828963084)
,p_plug_template_id=>wwv_flow_imp.id(72041511666958963083)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041512255222963084)
,p_plug_template_id=>wwv_flow_imp.id(72041511666958963083)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041512550795963084)
,p_plug_template_id=>wwv_flow_imp.id(72041511666958963083)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041532018203963094)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041532379287963094)
,p_plug_template_id=>wwv_flow_imp.id(72041532018203963094)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041532620953963094)
,p_plug_template_id=>wwv_flow_imp.id(72041532018203963094)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041532979132963095)
,p_plug_template_id=>wwv_flow_imp.id(72041532018203963094)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041533270407963095)
,p_plug_template_id=>wwv_flow_imp.id(72041532018203963094)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041533592050963095)
,p_plug_template_id=>wwv_flow_imp.id(72041532018203963094)

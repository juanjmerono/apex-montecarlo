...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041506609566963081)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041506909940963081)
,p_plug_template_id=>wwv_flow_imp.id(72041506609566963081)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041507222005963081)
,p_plug_template_id=>wwv_flow_imp.id(72041506609566963081)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041507517010963081)
,p_plug_template_id=>wwv_flow_imp.id(72041506609566963081)
,p_name=>'Button Start'

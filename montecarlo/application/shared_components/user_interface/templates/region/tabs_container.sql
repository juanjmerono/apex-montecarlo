...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041524327705963089)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041524605336963090)
,p_plug_template_id=>wwv_flow_imp.id(72041524327705963089)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041524919590963090)
,p_plug_template_id=>wwv_flow_imp.id(72041524327705963089)
,p_name=>'Tabs'

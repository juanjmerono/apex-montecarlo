...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041499101239963077)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041499454504963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041499718954963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041500005377963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041500309435963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041500606611963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041500916130963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041501259154963078)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041501582987963079)
,p_plug_template_id=>wwv_flow_imp.id(72041499101239963077)
,p_name=>'Sub Regions'

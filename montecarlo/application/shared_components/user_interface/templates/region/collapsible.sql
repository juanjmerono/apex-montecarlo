...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041466668134963062)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041466992877963062)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041467205822963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041467567056963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041467844592963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041468159863963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041468425333963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041468750798963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041469053829963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041469332055963063)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041469620580963064)
,p_plug_template_id=>wwv_flow_imp.id(72041466668134963062)
,p_name=>'Sub Regions'

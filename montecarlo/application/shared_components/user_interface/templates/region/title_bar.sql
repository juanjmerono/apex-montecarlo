...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041526964042963091)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041527293454963091)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041527535926963092)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041527839503963092)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041528193492963092)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041528474835963092)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041528787115963092)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041529011104963092)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041529387943963093)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041529639354963093)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041529942801963093)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041530274598963093)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041530581107963093)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041530833143963093)
,p_plug_template_id=>wwv_flow_imp.id(72041526964042963091)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

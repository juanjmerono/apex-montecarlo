...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041484510977963070)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041484880090963071)
,p_plug_template_id=>wwv_flow_imp.id(72041484510977963070)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041485124705963071)
,p_plug_template_id=>wwv_flow_imp.id(72041484510977963070)
,p_name=>'Sub Regions'

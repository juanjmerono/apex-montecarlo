...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041509199762963082)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041509407788963082)
,p_plug_template_id=>wwv_flow_imp.id(72041509199762963082)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041509785778963083)
,p_plug_template_id=>wwv_flow_imp.id(72041509199762963082)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041510098041963083)
,p_plug_template_id=>wwv_flow_imp.id(72041509199762963082)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041510386342963083)
,p_plug_template_id=>wwv_flow_imp.id(72041509199762963082)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041510609114963083)
,p_plug_template_id=>wwv_flow_imp.id(72041509199762963082)
,p_name=>'Sub Regions'

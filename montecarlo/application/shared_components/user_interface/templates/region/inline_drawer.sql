...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041494549488963075)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041494867273963075)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041495153692963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041495411784963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041495761107963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041496062432963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041496312124963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041496648200963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041496903691963076)
,p_plug_template_id=>wwv_flow_imp.id(72041494549488963075)
,p_name=>'Sub Regions'

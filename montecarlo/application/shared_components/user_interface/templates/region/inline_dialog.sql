...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041489986960963073)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041490214929963073)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041490551868963073)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041490821710963074)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041491145886963074)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041491402572963074)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041491740820963074)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041492071521963074)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041492302099963074)
,p_plug_template_id=>wwv_flow_imp.id(72041489986960963073)
,p_name=>'Sub Regions'

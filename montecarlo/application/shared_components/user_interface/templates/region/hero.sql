...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041481051382963069)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041481308543963069)
,p_plug_template_id=>wwv_flow_imp.id(72041481051382963069)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041481690776963069)
,p_plug_template_id=>wwv_flow_imp.id(72041481051382963069)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041481921526963069)
,p_plug_template_id=>wwv_flow_imp.id(72041481051382963069)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041482220783963069)
,p_plug_template_id=>wwv_flow_imp.id(72041481051382963069)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041482552653963069)
,p_plug_template_id=>wwv_flow_imp.id(72041481051382963069)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

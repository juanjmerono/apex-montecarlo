...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(72041504585026963080)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041504805387963080)
,p_plug_template_id=>wwv_flow_imp.id(72041504585026963080)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041505174538963080)
,p_plug_template_id=>wwv_flow_imp.id(72041504585026963080)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041505463982963080)
,p_plug_template_id=>wwv_flow_imp.id(72041504585026963080)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041505790814963081)
,p_plug_template_id=>wwv_flow_imp.id(72041504585026963080)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041506095257963081)
,p_plug_template_id=>wwv_flow_imp.id(72041504585026963080)
,p_name=>'Sub Regions'

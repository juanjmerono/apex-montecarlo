...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(72041411827561963029)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041412110229963030)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041412418134963030)
,p_page_template_id=>wwv_flow_imp.id(72041411827561963029)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041412726828963030)
,p_page_template_id=>wwv_flow_imp.id(72041411827561963029)

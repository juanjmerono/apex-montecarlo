...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(72041422463850963035)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041422728832963036)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041423085682963036)
,p_page_template_id=>wwv_flow_imp.id(72041422463850963035)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041423338328963036)
,p_page_template_id=>wwv_flow_imp.id(72041422463850963035)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041423619045963036)
,p_page_template_id=>wwv_flow_imp.id(72041422463850963035)
,p_name=>'Body Footer'

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(72041432413083963041)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041432777953963041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041433048510963042)
,p_page_template_id=>wwv_flow_imp.id(72041432413083963041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041433327598963042)
,p_page_template_id=>wwv_flow_imp.id(72041432413083963041)

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(72041433968551963042)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041434202114963042)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041434549162963043)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041434838144963043)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041435195043963043)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041435478436963043)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041435743128963043)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041436057720963043)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041436388992963044)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041436602307963044)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041436962704963044)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041437280171963044)
,p_page_template_id=>wwv_flow_imp.id(72041433968551963042)

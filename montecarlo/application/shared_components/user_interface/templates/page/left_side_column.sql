...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(72041414742503963031)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041415083388963031)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041415314512963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041415618120963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041415958740963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041416263877963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041416535616963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041416877342963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041417159588963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041417455729963032)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041417737175963033)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72041418096430963033)
,p_page_template_id=>wwv_flow_imp.id(72041414742503963031)
